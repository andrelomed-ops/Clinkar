...
export async function POST(request: NextRequest) {
    try {
        ...
        switch (payload.event) {
            case 'order.created':
                console.log('[Clinkargo] Transport order created:', payload.order.partner_order_id);
                break;
            ...
            case 'order.picked_up':
                console.log('[Clinkargo] Vehicle picked up:', payload.order.partner_order_id);
                break;

            case 'order.in_transit':
                console.log('[Clinkargo] Vehicle in transit:', payload.order.partner_order_id);
                break;

            case 'order.delivered':
                console.log('[Clinkargo] Vehicle delivered:', payload.order.partner_order_id);
                break;

            case 'order.cancelled':
                console.log('[Clinkargo] Transport cancelled:', payload.order.partner_order_id);
                break;
