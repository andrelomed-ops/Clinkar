...
export function Navbar({
    ...
    return (
        <>
            <nav className={cn(
                "fixed top-0 z-50 w-full transition-all duration-300 border-b overflow-hidden",
                ...
                <div className="mx-auto flex h-16 w-full lg:max-w-7xl items-center justify-between px-4 sm:px-6 overflow-hidden min-w-0" style={{ maxWidth: '100vw' }}>
                            ...
                            {!user ? (
                                ...
                                >
                                    <StarterKarLogo 
                                        ...
                                        href=""
                                    />
                                    <span className="hidden lg:inline text-[10px] font-black uppercase tracking-widest text-zinc-600 dark:text-zinc-400 group-hover:text-indigo-600 transition-colors">
                                        Entrar
                                    </span>
                                </Link>
                            ) : (
