    ...
    return (
        <div className="flex items-start gap-3 p-4 bg-slate-50 border border-slate-100 rounded-xl text-[10px] text-slate-400">
            ...
            <p className="leading-relaxed">
                <strong className="font-semibold text-slate-500">Aviso Legal:</strong> StarterKar opera exclusivamente como enlace tecnológico y no es una entidad financiera.
                ...
                y políticas de la institución financiera seleccionada. StarterKar no garantiza la aprobación del crédito.
            </p>
        </div>
    );
}
