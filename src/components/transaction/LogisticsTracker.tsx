...
export const LogisticsTracker = ({ origin, destination, status, eta }: LogisticsTrackerProps) => {
    return (
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-border dark:border-zinc-800 shadow-sm overflow-hidden">
            {/* Mock Map Header */}
            <div className="h-32 bg-slate-100 dark:bg-zinc-950 relative w-full overflow-hidden">
                ...
                {/* Route Line Mock */}
                <div className="absolute top-1/2 left-10 right-10 h-1 bg-slate-300 dark:bg-slate-700 rounded-full">
                ...
                <div className="absolute top-1/2 left-10 -translate-y-1/2 -ml-1.5 h-4 w-4 rounded-full bg-slate-400 border-2 border-white dark:border-zinc-900 shadow-sm" />
                <div className="absolute top-1/2 right-10 -translate-y-1/2 -mr-1.5 h-4 w-4 rounded-full bg-primary border-2 border-white dark:border-zinc-900 shadow-sm ring-4 ring-primary/20" />
            ...
            <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h3 className="font-bold text-lg text-foreground">Rastreo de Envío</h3>
                        <p className="text-sm text-muted-foreground">Transportes Castores S.A. de C.V.</p>
                    </div>
                    <div className="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg text-xs font-black uppercase">
                ...
                <div className="grid grid-cols-2 gap-8 relative">
                    {/* Connector Line */}
                    <div className="absolute left-3 top-2 bottom-4 w-0.5 bg-slate-200 dark:bg-zinc-800" />

                    <div className="relative pl-8">
                        <div className="absolute left-0 top-1 h-6 w-6 rounded-full bg-slate-100 dark:bg-zinc-800 border border-slate-300 dark:border-zinc-700 flex items-center justify-center z-10">
