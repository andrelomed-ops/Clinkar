...
export function CarDetailClient({ 
    ...
    return (
        <div className="min-h-screen bg-background relative w-full min-w-0 overflow-x-hidden" style={{ position: 'relative' }}>
            <Navbar variant="market" />

            <div className="pt-24 pb-20 px-5 sm:px-6 w-full lg:max-w-7xl mx-auto block relative min-w-0 overflow-x-hidden">
