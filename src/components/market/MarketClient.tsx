...
import { Shield, Search, Filter, MapPin, Tag, SlidersHorizontal, ChevronRight, CarFront, ArrowRight, Heart } from "lucide-react";
...
export function MarketClient({ 
    ...
    const filteredCars = useMemo(() => {
        return cars.filter(car => {
            ...
            if (filters.certifiedOnly && !car.has_clinkar_seal && !car.has_starterkar_seal) return false;
