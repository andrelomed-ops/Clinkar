            ...
            <div className="relative z-10">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm font-bold text-muted-foreground uppercase tracking-[0.2em] ml-1">Historial Inmutable StarterKar v2.0</p>
                    </div>

                    <div className="flex flex-col items-end gap-2">
                        <StarterKarSeal variant="holographic" score={data.score} className="!p-3 border-none shadow-none" />
                    </div>
                ...
                <div className="mt-16 p-8 bg-indigo-50 dark:bg-indigo-900/10 rounded-[2.5rem] border border-indigo-100 dark:border-indigo-500/20 text-center space-y-4">
                    <p className="text-sm font-bold text-indigo-600 dark:text-indigo-400 flex items-center justify-center gap-2">
                        ...
                        Toda la información ha sido encriptada y distribuida en la red StarterKar.
                    </p>
